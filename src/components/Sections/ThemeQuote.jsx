...
function ThemeQuote() {
  return (
    <section className="text-blue-950 body-font border-t bg-stone-100">
      <div className="container px-5 py-12 mx-auto">
        <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          ...
          <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm mb-1">
            –Moses 6:34
          </h2>
        </div>
      </div>
